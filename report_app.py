...
UNIT_LIST = [f"<Unit {i:02d}>" for i in range(1, 17)] # 꺽쇠 형식 유닛
...
if st.session_state.page == 'input':
    ...
    elt_unit = st.selectbox("ELT Unit", ["선택 안 함"] + UNIT_LIST)
